...
public class SideBar extends View {
    ...
    public void setIndexText(ArrayList<String> indexStrings) {
        ...
        if (indexStrings.size() > 20) {
        } else if (indexStrings.size() > 15) {
            getLayoutParams().height = indexStrings.size() * 80;

        } else if (indexStrings.size() > 10) {
            getLayoutParams().height = indexStrings.size() * 120;

        } else {
            getLayoutParams().height = indexStrings.size() * 180;
        }
        invalidate();
    }
